...
module X_AXIS_PARTS(){
    MOV([0, Y_MIN + Y_POS, FRAME_Z-20-PORTAL_H]) PORTAL();
    MOV([30, FRAME_Y+MOTOR_MOUNT_Y*0.5, FRAME_Z-20-MOTOR_MOUNT_L*0.5]) 
        MOTOR_X1();
    MOV([FRAME_X-30, FRAME_Y+MOTOR_MOUNT_Y*0.5, FRAME_Z-30-MOTOR_MOUNT_L*0.5]) 
        MOTOR_X2();
    BELT_X1(PORTAL_CORE_X1, FRAME_Y + MOTOR_MOUNT_Y*0.5, FRAME_X-PORTAL_CORE_X1, BELT_BEARING_Y, X_MIN + X1_POS, Y_MIN + Y_POS, FRAME_Z-7);
    BELT_X2(PORTAL_CORE_X1, FRAME_Y + MOTOR_MOUNT_Y*0.5, FRAME_X-PORTAL_CORE_X1, BELT_BEARING_Y, X_MIN + X2_POS, Y_MIN + Y_POS, FRAME_Z-17);
}
